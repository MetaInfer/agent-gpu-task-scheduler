...
- Select `required_worker_id` from the `allowed_worker_ids` supplied with this invocation;
  it must also be explicitly requested by the Proposal. Never invent another worker ID.
